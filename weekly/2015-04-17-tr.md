...
Bu hafta iki iojs sürümü yayınlandı [v1.7.0](https://iojs.org/dist/v1.7.0/) ve ardından [v1.7.1](https://iojs.org/dist/v1.7.1/), değişikliklerin hepsine [GitHub](https://github.com/iojs/io.js/blob/v1.x/CHANGELOG.md) üzerinden göz atabilirsiniz.
